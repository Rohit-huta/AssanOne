...
const Aside = ({ myAccActiveButton, setMyAccActiveButton }) => {
  ...
  useEffect(() => {
    if (location.pathname === "/myAccount") setIsMyAccount(!isMyAccount);
  }, [location]);
    ...
    <div className="sticky-top sticky-offset">
      ...
      <div className="welcome d-flex">
        ...
        <div className="mx-3 my-3">
          <p className="m-0 text-primary" style={{ textAlign: "start" }}>
            Welcome!
          </p>
      ...
      {isMyAccount ? (
        <div className="d-flex flex-column align-items-start">
          <Sidebar
            myAccActiveButton={myAccActiveButton}
          ...
          <ul className="navbar-nav ">
            ...
            >
              ...
              <Link to="/dashboard" className="text-decoration-none text-black">
                <button
                  className={`btn bg-white border-0 fs-5 ${
                    activeButton === "dashboard" ? "activee" : ""
                  }`}
            ...
            >
              ...
              >
                <button
                  className={`btn bg-white text-black border-0 fs-5 ${
                    activeButton === "buyOnline" ? "activee" : ""
                  }`}
            ...
            >
              ...
              >
                <button
                  className={`btn bg-white text-black border-0 fs-5 ${
                    activeButton === "savedQuotes" ? "activee" : ""
                  }`}
            ...
            <li
              className="nav-item d-flex fs-5 mb-4 justify-content-start"
              style={{}}
            >
              ...
              <Link to="/prospects" className="text-decoration-none text-black">
                <button
                  className={`btn bg-white text-black border-0 fs-5 ${
                    activeButton === "Prospects" ? "activee" : ""
                  }`}
            ...
            >
              ...
              <Link to="/customers" className="text-decoration-none text-black">
                <button
                  className={`btn bg-white text-black border-0 fs-5 ${
                    activeButton === "Customers" ? "activee" : ""
                  }`}
